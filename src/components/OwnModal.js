  ...
  return (
    <>
      ...
      >
        ...
        <hr />
        <Input placeholder="Age" value={age} onChange={handleChange}  name="age"/>
        <hr />
        <Input placeholder="Course" value={course} onChange={handleChange}  name="course"/>
        <hr />
        <Input placeholder="Phone" value={phone} onChange={handleChange} name="phone" />
      </Modal>
    </>
  );
}
